        ...
        >
          ...
          <div
            className={`p-8 flex flex-col justify-center ${
              isRTL ? "md:col-start-1 text-right" : "text-left"
            }`}
          >
            <h2
              className="mb-4 text-[#111827] group-hover:text-[#5FB57A] transition-colors"
            ...
            {/* Meta */}
            <div
              className={`flex flex-wrap items-center gap-4 text-sm text-[#6B7280] ${
                isRTL ? "flex-row-reverse" : ""
              }`}
            >
              <div
              ...
              >
                ...
                <span>
                  {readingTime} {language === "en" ? "min read" : "دقيقة"}
                </span>
              </div>
            </div>
          </div>
