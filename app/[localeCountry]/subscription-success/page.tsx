...
import { CheckCircle, MessageCircle, Home, List } from "lucide-react";
...
export default function SubscriptionSuccessPage() {
  ...
  // Extract order info from URL query parameters
  const orderId = searchParams.get("orderId") || "SUB-XXXX-XXXX";
                ...
                <div className={`flex gap-4 ${isRTL ? 'flex-row-reverse text-right' : ''}`}>
                  ...
                  <div className="flex-1 pt-1">
                    ...
                    <p className="text-[#6B7280] text-sm">
                      {locale === "en"
                        ? `Our team will reach out to ${whatsappNumber || "your number"} within 24 hours`
                        : `سيتواصل فريقنا معك على ${whatsappNumber || "رقمك"} خلال 24 ساعة`}
                    </p>
                  </div>
                </div>
