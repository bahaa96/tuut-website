...
export function CommunityActivity() {
  ...
  const topContributors: Contributor[] = [
    {
      username: "Vicoo821",
      badge: m.DEAL_DETECTIVE(),
      badgeColor: "bg-[#5FB57A]",
      icon: "detective",
      stat: "1,129",
      statLabel: m.CONTRIBUTED(),
    },
    {
      username: "Vicoo821",
      badge: m.SAVINGS_HERO(),
      badgeColor: "bg-[#5FB57A]",
      icon: "hero",
      stat: "$492",
      statLabel: m.HELPED_MEMBERS_SAVE(),
    },
    {
      username: "GoJOSatoru",
      badge: m.TEST_WIZ(),
  ...
  const popularStores: PopularStore[] = [
    {
      name: "Etsy",
      avgSavings: m.AVG_SAVINGS({ amount: "$32" }),
    },
    {
      name: "Mercari",
      avgSavings: m.AVG_SAVINGS({ amount: "$17" }),
    },
    {
      name: "Vistaprint",
      avgSavings: m.AVG_SAVINGS({ amount: "$51" }),
    },
    {
      name: "Jiffy Lube",
      avgSavings: m.AVG_SAVINGS({ amount: "$30" }),
    },
  ];
  ...
  const hotCodes: HotCode[] = [
    {
      ...
      description:
        language === "en"
          ? "10% Off (Storewide) at Lumin"
          : "خصم 10% (على كل المتجر) في Lumin",
    ...
    },
    {
      ...
      description:
        language === "en"
          ? "20% Off Storewide at Paranormal Cirque"
          : "خصم 20% على كل المتجر في Paranormal Cirque",
    ...
    },
    {
      ...
      description:
        language === "en"
          ? "15% Off Storewide at Crunchyroll"
          : "خصم 15% على كل المتجر في Crunchyroll",
    ...
    },
    {
      ...
      description:
        language === "en"
          ? "$25 Off Storewide at 4imprint"
          : "خصم $25 على كل المتجر في 4imprint",
  ...
  const todaysActivity: Activity[] = [
    {
      ...
      action: m.VERIFIED_CODE(),
      code: "EMAIL",
      store: "Castano Group",
      time: m.$SECONDS_AGO({ seconds: 45 }),
      status: "verified",
    },
    {
      username: "RonJrJohnson",
      ...
      code: "IGNITE10FF",
      store: "ProVape",
      time: m.$SECONDS_AGO({ seconds: 56 }),
      status: "verified",
    },
    {
      username: "Kony24",
      action: m.INVALIDATED_CODE(),
      code: "Prime",
      store: "Village Hat Shop",
      time: m.$SECONDS_AGO({ seconds: 58 }),
      status: "invalidated",
    },
    {
      ...
      <div className="container mx-auto max-w-[1200px] px-4 md:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            >
              {m.COMMUNITY_ACTIVITY()}
            </h2>
            <p className="text-[#6B7280]">
              {m.SEE_WHAT_OUR_COMMUNITY_MEMBERS_ARE_SAVING_RIGHT_NOW()}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-[#E8F3E8] border-2 border-[#111827] rounded-xl shadow-[3px_3px_0px_0px_rgba(17,24,39,1)]">
              <h3
                className="text-xl mb-4 text-[#111827]"
                style={{ fontWeight: 700 }}
              >
                {m.FIND_VERIFIED_COUPON_CODES()}
              </h3>
              <p className="text-[#6B7280] text-sm mb-6">
                {m.SEARCH_FROM_OVER_400_000_STORES()}
              </p>
              ...
              <div className={`flex gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
                <div className="flex-1 relative">
                  ...
                  <Input
                    type="text"
                    placeholder={m.WHERE_ARE_YOU_SHOPPING_TODAY()}
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className={`border-2 border-[#111827] h-12 ${
                      isRTL ? "pr-12" : "pl-12"
                    } rounded-lg bg-white`}
                  />
                </div>
                <Button className="bg-[#5FB57A] hover:bg-[#4FA569] text-white h-12 px-6 rounded-lg border-2 border-[#111827] shadow-[2px_2px_0px_0px_rgba(17,24,39,1)] hover:shadow-[1px_1px_0px_0px_rgba(17,24,39,1)] transition-all">
                  {m.FIND()}
                </Button>
              </div>
            </Card>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {hotCodes.map((code, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-[#6B7280] mb-2 line-clamp-2">
                      {code.description}
                    </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 border-2 border-[#111827] rounded-xl shadow-[3px_3px_0px_0px_rgba(17,24,39,1)]">
              ...
              <div className="mb-6">
                <h4
                  className="text-sm mb-4 text-[#6B7280]"
                  style={{ fontWeight: 600 }}
                >
                  {m.THIS_WEEKS_TOP_CONTRIBUTORS()}
                </h4>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {topContributors.map((contributor, index) => (
                    ...
                    >
                      ...
                      <Badge
                        className={`${contributor.badgeColor} text-white text-[10px] mb-2 border-0 rounded px-2`}
                      >
                        {contributor.badge}
                      </Badge>
                      <div
              ...
              <div className="grid grid-cols-3 gap-3 mt-6 pt-6 border-t-2 border-[#E5E7EB]">
                <div className="text-center">
                  <div
                    className="text-2xl text-[#5FB57A] mb-1"
                    style={{ fontWeight: 700 }}
                  >
                    $1,825
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-[#6B7280]">{m.VERIFIED()}</div>
                </div>
                <div className="text-center">
                  <div
                    className="text-2xl text-[#5FB57A] mb-1"
