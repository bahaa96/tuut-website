      ...
      <div className="container mx-auto max-w-[800px] px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="text-[#6B7280] mb-4" style={{ fontSize: "18px" }}>
            {isRTL
              ? "اكتشف أفضل العروض والكوبونات من أكثر من 500 متجر"
              : "Discover the best deals and coupons from 500+ top brands"}
          </p>
          ...
          <div className="max-w-3xl mx-auto">
            <form onSubmit={handleSearch} className="relative flex gap-2">
              <div className="relative flex-1">
                <Search
                  className={`absolute top-1/2 -translate-y-1/2 h-6 w-6 text-[#6B7280] ${
                ...
                <Input
                  ...
                  placeholder={
                    isRTL
                      ? "ابحث عن المتاجر أو العروض أو الفئات..."
                      : "Search for stores, deals, or categories..."
                  }
                  className={`h-16 ${
                    isRTL ? "pr-16 text-right" : "pl-16"
                  } text-lg border-2 border-[#111827] rounded-2xl shadow-[6px_6px_0px_0px_rgba(17,24,39,1)] focus-visible:outline-none transition-all`}
                />
              </div>
              <Button
                type="submit"
